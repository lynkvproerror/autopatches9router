...
- API Patch 28 restores default upstream account selection. It removes only recognized legacy v1/v2/v3 tier-routing assignments and otherwise leaves credential selection unchanged.
